...
QUARANTINE: dict[str, str] = {
    ...
    "app.api.v1.redteam": "app.db.models.connector_config",
    ...
    "app.connectors.registry": "app.db.models.connector_config",
    "app.evaluation.runner": "app.db.models.connector_config",
